...
">
                        ...
                        <div class="profile-settings__form-group">
                            ...
                            <input type="text" name="address-line-1" id="address-line-1" class="profile-settings__form-input" placeholder="John Doe">
                        </div>
                        <div class="profile-settings__form-group">
                            <label for="address-line-2" class="profile-settings__form-label">Address Line 2</label>
                            <input type="text" name="address-line-2" id="address-line-2" class="profile-settings__form-input" placeholder="John Doe">
                        </div>
                    </form>
                </div>
                <hr>
                <div class="profile-settings__form">
                    ...
                    <form action="" method="POST" id="update-password">
                        ...
                        <div class="profile-settings__form-group">
                            ...
                            <input type="password" name="new-password" id="new-password" class="profile-settings__form-input" placeholder="John Doe">
                        </div>
                        <div class="profile-settings__form-group">
