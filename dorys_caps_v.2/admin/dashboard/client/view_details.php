...
<head>
    ...
    <link rel="stylesheet" href="/admin/vendors/css/view_details.css">

</head>
<body>
    <?php include  $_SERVER['DOCUMENT_ROOT'].'/admin/components/sidebar.php'; ?>

    <?php include  $_SERVER['DOCUMENT_ROOT'].'/admin/components/clients/view_details.php'; ?>

    <?php include  $_SERVER['DOCUMENT_ROOT'].'/admin/links/footer/footer_links.php'; ?>
    <script src="/admin/vendors/js/script.js"></script>
    <script src="/admin/vendors/js/view_details.js"></script>
</body>
