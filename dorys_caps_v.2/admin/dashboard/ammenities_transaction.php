...
<head>
    ...
    <title>Dashboard | Ammenities Transaction</title>
    ...
    <link rel="stylesheet" href="/admin/vendors/css/ammenities_transaction.css">
</head>
<body>
    <?php include  $_SERVER['DOCUMENT_ROOT'].'/admin/components/sidebar.php'; ?>

    <?php include  $_SERVER['DOCUMENT_ROOT'].'/admin/components/reservations/ammenity_table.php'; ?>

    <?php include  $_SERVER['DOCUMENT_ROOT'].'/admin/links/footer/footer_links.php'; ?>

    <script src="/admin/vendors/js/script.js"></script>
    <script src="/admin/vendors/js/ammenity_transaction.js"></script>
</body>
</html>