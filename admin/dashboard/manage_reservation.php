...
<head>
    ...
    <link rel="stylesheet" href="/admin/public/css/manage_reservation.css">
...
<body>
    ...
    <?php include  $_SERVER['DOCUMENT_ROOT'].'/admin/components/reservations/manage_reservation.php'; ?>
    
    <?php include  $_SERVER['DOCUMENT_ROOT'].'/admin/links/footer/footer_links.php'; ?>
    <script src="/admin/public/js/script.js"></script>
    <script src="/admin/public/js/client.js"></script>
</body>
