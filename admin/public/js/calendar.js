                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        const availableAppointment = async (dateId) => {
                            const res = await fetch('/admin/controller/AvailableAppointment.php', {
                                method: 'POST',
                                body: JSON.stringify({
                                    dateId: dateId
                                }),
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const disableAppointment = async (date_) => {
                        const res = await fetch('/admin/controller/DisableAppointment.php', {
                            method: 'POST',
                            body: JSON.stringify({
                                date: date_
                            }),
